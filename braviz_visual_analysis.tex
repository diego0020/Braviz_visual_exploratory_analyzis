...
\begin{figure}
\begin{center}
\includegraphics[width=0.6\linewidth]{figures/arquitecture.pdf}
\end{center}
...
\subsection{Specific contribution of BRAVIZ}
...
\subsection{Scientific discovery (outliers, ancillary hypotheses)}
...
\subsubsection{Correlations viewer for neuroscience data (scatters and matrices, real-time statistics)}
...
\begin{figure}
	\centering
		\includegraphics[width=\linewidth]{figures/cases/cyril_plot}
...
\begin{figure}
	\centering
		\includegraphics[width=\linewidth]{figures/cases/cc_cyril}
...
\subsubsection{Correlations viewer for clinical data}
...
\begin{figure}
	\centering
		\includegraphics[width=0.9\linewidth]{figures/cases/cyricl_corr_1}
...
\begin{figure}
	\centering
		\includegraphics[width=0.9\linewidth]{figures/cases/corr_cyril_2}
...
\subsection{Further Exploration: Periventricular Leukomalacia}
\label{sec_pvm_case}
...
\begin{figure}
\begin{center}
\includegraphics[width=\linewidth,trim = 30mm 90mm 60mm 10mm ,clip]{figures/cases/parallel_coordinates_raw}
\end{center}
...
The presented case illustrate how BRAVIZ can be used to increase understanding of a real data-set. 
