...
% Comprehend subjects as a whole
...
% In addition to confirmation, there is a need to explore the data to find new (surprising) hypotheses
% Appropriate tools for exploratory analysis not the same as for confirmatory
% Multiple iterations through data
...
% Moreover, experts from multiple disciplines
...
% Limitations and bottlenecks with current tools
